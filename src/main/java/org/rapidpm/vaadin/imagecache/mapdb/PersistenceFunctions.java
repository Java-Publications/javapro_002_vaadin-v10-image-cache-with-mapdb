...
public interface PersistenceFunctions {
  ...
  static Function<String, DatabasePair> cachingDB() {
    return (name) -> {
  ...
  static BiFunction<DatabasePair, String, HTreeMap<String, byte[]>> mapOnDisc() {
  ...
  static BiFunction<DatabasePair, String, HTreeMap<String, byte[]>> mapInMemoryPersistentOnDisc() {
